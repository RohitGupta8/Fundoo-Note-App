...
describe("Get Label By ID", () => {
  ...
  it("check Data from DB not from Redis with false input,Should response 400", (done) => {
    const token = labelData.notes.inValidToken;
    chai
      .request(server)
      .get("/label/61d179c1d67af48269572ada")
  ...
  it("check Data from Redis with true input,Should response 201", (done) => {
    const token = labelData.notes.validToken;
    chai
      .request(server)
      .get("/label/61d179c1d67af48269572ada")
  ...
  it("check Data from Db after clear cache,Should response 201", (done) => {
    const token = labelData.notes.validToken;
    chai
      .request(server)
      .get("/label/61d179c1d67af48269572ada")
